...
public class JDialog_AddCompAcc extends javax.swing.JDialog {
	...
	public JDialog_AddCompAcc(BankFrm parent) {
        ...
        JTextField_NAME.setInputVerifier(new InputValidation());
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        parentframe.noEmployee = Integer.parseInt(JTextField_NoOfEmp.getText());


        if(!checkValidation(JTextField_ACNR))
            JTextField_ACNR.requestFocus();
        else {
	...
	private boolean checkValidation(JTextField anyField) {

        System.out.println("start..........");

		if ("".equals(anyField.getText()))

		{  //User have not entered anything.
